...
class _$StudentImpl implements _Student {
  const _$StudentImpl(
      ...
      required this.lastLoginAt,
      required this.level,
      required final List<String> badgeIds,
  ...
  @override
  String toString() {
    return 'Student(id: $id, email: $email, name: $name, role: $role, createdAt: $createdAt, lastLoginAt: $lastLoginAt, level: $level, badgeIds: $badgeIds, totalQuizzesTaken: $totalQuizzesTaken, averageScore: $averageScore)';
  }
...
abstract class _Student implements Student {
  const factory _Student(
      ...
      required final List<String> badgeIds,
      required final int totalQuizzesTaken,
      required final double averageScore}) = _$StudentImpl;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      lastLoginAt: null == lastLoginAt
          ...
          : lastLoginAt // ignore: cast_nullable_to_non_nullable
              as DateTime,
      createdQuizIds: null == createdQuizIds
          ? _value.createdQuizIds
          : createdQuizIds // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ) as $Val);
  }
}
...
class _$TeacherImpl implements _Teacher {
  const _$TeacherImpl(
      ...
      required this.createdAt,
      required this.lastLoginAt,
      required final List<String> createdQuizIds})
      : _createdQuizIds = createdQuizIds;
  ...
  @override
  final DateTime lastLoginAt;
  final List<String> _createdQuizIds;
  @override
  List<String> get createdQuizIds {
    if (_createdQuizIds is EqualUnmodifiableListView) return _createdQuizIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_createdQuizIds);
  }

  @override
  String toString() {
    return 'Teacher(id: $id, email: $email, name: $name, role: $role, createdAt: $createdAt, lastLoginAt: $lastLoginAt, createdQuizIds: $createdQuizIds)';
  }
...
abstract class _Teacher implements Teacher {
  const factory _Teacher(
      ...
      required final DateTime createdAt,
      required final DateTime lastLoginAt,
      required final List<String> createdQuizIds}) = _$TeacherImpl;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      lastLoginAt: null == lastLoginAt
          ...
          : lastLoginAt // ignore: cast_nullable_to_non_nullable
              as DateTime,
      auditLogIds: null == auditLogIds
          ? _value.auditLogIds
          : auditLogIds // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ) as $Val);
  }
}
...
class _$AdminImpl implements _Admin {
  const _$AdminImpl(
      ...
      required this.createdAt,
      required this.lastLoginAt,
      required final List<String> auditLogIds})
      : _auditLogIds = auditLogIds;
  ...
  @override
  final DateTime lastLoginAt;
  final List<String> _auditLogIds;
  @override
  List<String> get auditLogIds {
    if (_auditLogIds is EqualUnmodifiableListView) return _auditLogIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_auditLogIds);
  }

  @override
  String toString() {
    return 'Admin(id: $id, email: $email, name: $name, role: $role, createdAt: $createdAt, lastLoginAt: $lastLoginAt, auditLogIds: $auditLogIds)';
  }
...
abstract class _Admin implements Admin {
  const factory _Admin(
      ...
      required final DateTime createdAt,
      required final DateTime lastLoginAt,
      required final List<String> auditLogIds}) = _$AdminImpl;
